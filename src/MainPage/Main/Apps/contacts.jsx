                    ...
                    <div className="contact-box">
                      <div className="row">
                        <div className="contact-cat col-sm-4 col-lg-3">
                          <a href="#" className="btn btn-primary btn-block w-100" data-bs-toggle="modal" data-bs-target="#add_contact"><i className="fa fa-plus" /> Add Contact</a>
                                ...
                                <ul className="contact-action">
                                  <li className="dropdown dropdown-action">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-right">
                                      <a className="dropdown-item" href="" data-bs-toggle="modal" data-bs-target="#edit_contact">Edit</a>
                                      <a className="dropdown-item" href="" data-bs-toggle="modal" data-bs-target="#delete_contact">Delete</a>
                                    </div>
                                  </li>
                                </ul>
                              </div>
